@extends('layouts.appmaster') @section('title', 'Portfolio Page')
@section('content')
		...
		<div class="accordion-item">
			<h2 class="accordion-header" id="headingOne">
				<button class="accordion-button collapsed" type="button"
					...
					aria-expanded="true" aria-controls="collapseOne">Education History
				</button>
			</h2>
				...
				<div class="accordion-body">
						...
						<tbody>
								...
								<td><a class="btn btn-info"
									href="{{URL::to('/updateEducation/'.$record->getId())}}">Update</a></td>
								<td><a class="btn btn-danger"
									href="{{URL::to('/deleteEducation/'.$record->getId())}}">Delete</a></td>
							</tr>
                                <?php }?>
                                </tbody>
					</table>
		...
		<div class="accordion-item">
			<h2 class="accordion-header" id="headingTwo">
				<button class="accordion-button collapsed" type="button"
					...
					aria-expanded="false" aria-controls="collapseTwo">Employment
					History</button>
			</h2>
				...
				<div class="accordion-body">
						...
						<tbody>
                            ...
                            <tr>
								...
								<td><a class="btn btn-info"
									href="{{URL::to('/updateEmployment/'.$job->getId())}}">Update</a></td>
								<td><a class="btn btn-danger"
									href="{{URL::to('/deleteEmployment/'.$job->getId())}}">Delete</a></td>
							</tr>
                            <?php }?>
                            </tbody>
					</table>
                        ...
                        <div class="mt-3">
						<a class="btn btn-success" href="/addEmploymentForm">Add
							Employment</a>
					</div>
				</div>
			</div>
