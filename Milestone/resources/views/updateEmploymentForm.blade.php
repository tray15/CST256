			...
			<div class="row m-2">
				...
				<div class="col-lg-4 mx-auto">
					<input class="form-control" type="text" name="start_date"
						value="<?php echo $record->start_date ?>"
			...
			<div class="row m-2">
				<div class="col-lg-4 mx-auto">
					<input class="form-control" type="text" name="name"
						value="<?php echo $record->company_name ?>" />
				</div>
			...
			<div class="row m-2">
				<div class="col-lg-4 mx-auto">
					<input class="form-control" type="text" name="title"
						value="<?php echo $record->job_title ?>" />
				</div>
			...
			<div class="row m-2">
				<div class="col-lg-4 mx-auto">
					<input class="form-control" type="text" name="supervisor"
						value="<?php echo $record->supervisor ?>" />
				</div>
			...
			<div class="row m-2">
				<div class="col-lg-4 mx-auto">
					<input class="form-control" type="textarea" name="separation"
						value="<?php echo $record->separation_reason ?>" />
				</div>
